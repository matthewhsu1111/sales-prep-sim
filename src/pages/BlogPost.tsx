...
const posts: Record<string, Post> = {
  'how-to-pass-sdr-interview-no-experience': {
    ...
    description: "How to pass an SDR interview with no sales experience: a 2026 guide to translating your background, telling your career change story, handling the roleplay round, and practicing the right way before your interview.",
    date: 'April 26, 2026',
    ...
    body: [
      ...
      { type: 'p', text: "The reframe is not lying. It is describing the same job in terms of what it actually proves about you. Here is how several common backgrounds translate:" },
      {
        ...
        headers: ['Background', 'How to reframe it'],
        rows: [
          { feature: 'Teaching', cells: ["You got skeptical people interested in things they didn't come in wanting to hear. Every day. With 30 different people at once. Say: \"I spent five years getting skeptical people bought into things they had no initial interest in. Every class, different audience, different resistance. That's the core motion of a cold call.\""] },
          { feature: 'Retail / Hospitality', cells: ["You handled real objections from real people under pressure with no preparation time. Say: \"I've been handling live objections from strangers, sometimes hundreds per shift, staying composed when people are difficult, and finding ways to move conversations forward.\""] },
          { feature: 'Military', cells: ["You execute under pressure, follow process, stay disciplined when conditions are hard. Say: \"I'm used to high-stakes environments where discipline and execution matter more than comfort. I show up consistently regardless of conditions.\""] },
          { feature: 'Management / Operations', cells: ["You've had difficult conversations and gotten things done through other humans. Say: \"I've spent years getting people to move in a direction they didn't initially want to go, navigating resistance, and finding ways to create buy-in.\""] },
        ],
      },
      ...
      { type: 'h3', text: '"Not interested." — Don\'t give up. Get curious.' },
      { type: 'p', text: "\"Totally fair — usually when I hear that it's either bad timing or it's just not a priority right now. Which one is it for you?\"" },
      { type: 'h3', text: '"Send me an email." — Agree. Then redirect.' },
      { type: 'p', text: "\"Happy to — so I don't send something useless, what would actually make it worth opening? Is it the ROI data or how we compare to what you're using now?\"" },
      { type: 'h3', text: '"We already use something." — Validate. Get underneath it.' },
      { type: 'p', text: "\"Good to know. When you say it's working — is it fully covering everything or more that it's good enough for now?\"" },
      { type: 'h3', text: '"Now isn\'t a good time." — Respect it. Keep the door open.' },
      { type: 'p', text: "\"Completely understand. Would it be better to circle back in a couple of months, or is it just today that's bad and this week could still work?\"" },
      ...
      {
        type: 'comparison-table',
        headers: ['When to practice', 'What to practice', 'Target reps'],
        rows: [
          { feature: '5+ days before', cells: ["\"Tell me about yourself\" — record yourself, watch it back, fix one thing per session", '10 reps minimum'] },
          { feature: '4 days before', cells: ['Cold call opener out loud — no objections yet, just the first 30 seconds', '15 reps'] },
          { feature: '3 days before', cells: ["\"Not interested\" and \"send me an email\" in isolation until automatic", '10 reps each'] },
          { feature: '2 days before', cells: ['Full cold call sequence with all four objections in random order', '5 full sessions'] },
          { feature: '1 day before', cells: ['Full mock interview including close — camera on, dressed for the interview', '2 full runs'] },
        ],
      },
